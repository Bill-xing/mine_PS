...
\SetStudentName{Jianming Xing}           % Your name
\SetProgramName{Robotics / Computer Science Graduate Program}           % Program you're applying for
\SetUniversityName{Target University}     % University name
